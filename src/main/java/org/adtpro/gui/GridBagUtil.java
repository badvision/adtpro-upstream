 ...
 * @version $Rev$-$Date: 2006/06/18 02:38:35 $$State: Exp $
 */
public class GridBagUtil {

    /**
     * constrain - Helper method for setting a componets constraints in a
     * gridbag layout; takes all of the possible parameters for grid
     * constraints.
     *
    ...
    /**
     * constrainLast - Helper method for setting a componets constraints in a
     * gridbag layout; takes all of the possible parameters for grid
     * constraints.
     *
     * @param container conatiner to add the component to
