...
public final class Gui extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else // _disconnectButton clicked
    ...
    class MenuAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            } else if ((e.getActionCommand().equals(Messages.getString("Gui.BS.DOS")))
                    || //$NON-NLS-1$
                    (e.getActionCommand().equals(Messages.getString("Gui.BS.DOS2")))
                    || //$NON-NLS-1$
                    (e.getActionCommand().equals(Messages.getString("Gui.BS.ProDOS")))
                    || //$NON-NLS-1$
                    (e.getActionCommand().equals(Messages.getString("Gui.BS.ProDOSFast")))
                    || //$NON-NLS-1
                    (e.getActionCommand().equals(Messages.getString("Gui.BS.ProDOSVSDrive")))
                    || //$NON-NLS-1
                    (e.getActionCommand().equals(Messages.getString("Gui.BS.ADT")))
                    || //$NON-NLS-1$
                    (e.getActionCommand().equals(Messages.getString("Gui.BS.ADTPro")))
                    || //$NON-NLS-1$
                    (e.getActionCommand().equals(Messages.getString("Gui.BS.ADTProAudio")))
                    || //$NON-NLS-1$
