...
public class SerialTransport extends ATransport {
    ...
    /**
     * Create a new instance of the Comm API Transport. This constructor creates
     * a new instance of the Comm API Transport.
     *
     * @param portName A string representing the Comm Port to be used.
     * @param speed
     * @throws NoSuchPortException
     * @throws PortInUseException
     * @throws UnsupportedCommOperationException
     * @throws IOException
     * @exception Exception used to pass any exceptions thrown during
     * initialization.
     */
     ...
     *
     * @exception Exception any exception encountered is rethrown.
     */
     ...
     *
     * @exception IOException thrown when a problem occurs with flushing the
     * stream.
     */
     ...
     * This method will return to the caller an array of strings representing
     * the serial ports available on this system.
     *
     ...
     * parameters.
     *
     * @exception IOException thrown when a problem occurs opening the stream.
     */
     ...
     * parameters.
     *
     * @exception IOException thrown when a problem occurs with opening the
     * stream.
     */
     ...
     *
     * @param port The port to set the transport to.
     * @param speed The speed to set the transport to.
     * @param hardware Boolean to say if hardware handshaking should be used
     * @exception IOException thrown when a problem occurs with flushing the
     * stream.
     */
    ...
    public String getInstructions(String guiString, int fileSize, int speed) {
        ...
        } else if (guiString.equals(Messages
